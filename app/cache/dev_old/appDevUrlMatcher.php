...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'omar_test_homepage')), array (  '_controller' => 'Omar\\TestBundle\\Controller\\DefaultController::indexAction',));
        }
        ...
        if (0 === strpos($pathinfo, '/shop/payment/debug/payment')) {
            // sonata_payment_debug
            if (preg_match('#^/shop/payment/debug/payment/(?P<check>[^/]++)/(?P<reference>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sonata_payment_debug')), array (  '_controller' => 'Sonata\\PaymentBundle\\Controller\\DebugPaymentController::paymentAction',));
            }

            // sonata_payment_debug_process
            if (preg_match('#^/shop/payment/debug/payment/(?P<check>[^/]++)/(?P<reference>[^/]++)/(?P<action>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sonata_payment_debug_process')), array (  '_controller' => 'Sonata\\PaymentBundle\\Controller\\DebugPaymentController::processPaymentAction',));
            }
