...
class __TwigTemplate_49dd2c9fcbc3271e45f2389f0f9786fa5ae0efc4fa865b604e610a108bcc3d08 extends Sonata\CacheBundle\Twig\TwigTemplate14
{
...
<tr";
        // line 12
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["formView"]) ? $context["formView"] : $this->getContext($context, "formView")), "quantity", array()), "vars", array()), "errors", array())) > 0)) {
            echo " class=\"danger unavailable\"";
        }
        echo ">
    ";
        // line 13
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["formView"]) ? $context["formView"] : $this->getContext($context, "formView")), "vars", array()), "errors", array())) > 0)) {
            echo " ";
            // line 14
            echo "        <td colspan=\"4\">";
    ...
    ";
            ...
            ";
            // line 17
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formView"]) ? $context["formView"] : $this->getContext($context, "formView")), "productId", array()), 'widget');
            echo "
            ...
            if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["formView"]) ? $context["formView"] : $this->getContext($context, "formView")), "quantity", array()), "vars", array()), "errors", array())) > 0)) {
                ...
                echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formView"]) ? $context["formView"] : $this->getContext($context, "formView")), "quantity", array()), 'errors');
                echo "</span>
            ";
            }
            // line 35
...
";
    ...
    public function block_product_thumbnail($context, array $blocks = array())
    {
        // line 20
        echo "                    ";
        echo $this->env->getExtension('sonata_media')->thumbnail($this->getAttribute($this->getAttribute((isset($context["basketElement"]) ? $context["basketElement"] : $this->getContext($context, "basketElement")), "product", array()), "image", array()), "preview", array("itemprop" => "image", "class" => "img-rounded img-responsive"));
        // line 21
        echo "                ";
    }
    ...
    public function block_product_sku($context, array $blocks = array())
    {
        ...
        echo ": ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["basketElement"]) ? $context["basketElement"] : $this->getContext($context, "basketElement")), "product", array()), "sku", array()), "html", null, true);
        echo "</p>
                ";
    }
    ...
    public function block_product_unit_price($context, array $blocks = array())
    {
        // line 39
        echo "                ";
        echo $this->env->getExtension('sonata_intl_number')->formatCurrency($this->getAttribute((isset($context["basketElement"]) ? $context["basketElement"] : $this->getContext($context, "basketElement")), "getUnitPrice", array(0 => true), "method"), $this->getAttribute($this->getAttribute((isset($context["basket"]) ? $context["basket"] : $this->getContext($context, "basket")), "currency", array()), "label", array()), array(), array(), $this->getAttribute((isset($context["basket"]) ? $context["basket"] : $this->getContext($context, "basket")), "locale", array()));
        echo "
            ";
    }
    ...
    public function block_product_quantity($context, array $blocks = array())
    {
        ...
        echo ">
                    ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formView"]) ? $context["formView"] : $this->getContext($context, "formView")), "quantity", array()), 'widget', array("attr" => array("class" => "input-mini", "min" => 1), "horizontal_input_wrapper_class" => ""));
        echo "
                </div>
            ";
    }
    ...
    public function block_product_total_inc($context, array $blocks = array())
    {
        // line 51
        echo "                ";
        echo $this->env->getExtension('sonata_intl_number')->formatCurrency($this->getAttribute((isset($context["basketElement"]) ? $context["basketElement"] : $this->getContext($context, "basketElement")), "getTotal", array(0 => true), "method"), $this->getAttribute($this->getAttribute((isset($context["basket"]) ? $context["basket"] : $this->getContext($context, "basket")), "currency", array()), "label", array()), array(), array(), $this->getAttribute((isset($context["basket"]) ? $context["basket"] : $this->getContext($context, "basket")), "locale", array()));
        echo "
            ";
    }
    ...
    public function block_product_delete($context, array $blocks = array())
    {
        // line 57
        echo "            ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formView"]) ? $context["formView"] : $this->getContext($context, "formView")), "delete", array()), 'widget', array("label_render" => false, "horizontal_input_wrapper_class" => "text-center"));
        echo "
        ";
    }
