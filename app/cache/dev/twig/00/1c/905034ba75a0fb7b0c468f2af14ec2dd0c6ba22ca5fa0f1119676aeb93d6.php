...
class __TwigTemplate_001c905034ba75a0fb7b0c468f2af14ec2dd0c6ba22ca5fa0f1119676aeb93d6 extends Sonata\CacheBundle\Twig\TwigTemplate14
{
...
<ul>
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["name"] => $context["format"]) {
            // line 42
            echo "        <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("sonata_media_view", array("id" => $this->env->getExtension('sonata_core_template')->getUrlsafeIdentifier((isset($context["media"]) ? $context["media"] : $this->getContext($context, "media"))), "format" => $context["name"])), "html", null, true);
            echo "\">";
