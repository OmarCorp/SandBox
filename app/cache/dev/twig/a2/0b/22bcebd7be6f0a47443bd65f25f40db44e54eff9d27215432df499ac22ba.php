...
class __TwigTemplate_a20b22bcebd7be6f0a47443bd65f25f40db44e54eff9d27215432df499ac22ba extends Sonata\CacheBundle\Twig\TwigTemplate14
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["code"] => $context["provider"]) {
            // line 19
            echo "            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "generateUrl", array(0 => "create", 1 => array("provider" => $context["code"])), "method"), "html", null, true);
            echo "\">";
