...
class __TwigTemplate_594a5ac3f56326926a6e326c6aa4623a01e97f99b016e6b8fbaace5e7bae26d2 extends Sonata\CacheBundle\Twig\TwigTemplate14
{
    ...
    public function block_sonata_address_render($context, array $blocks = array())
    {
        ...
        <div class=\"col-sm-";
        // line 4
        if ((isset($context["showEdit"]) ? $context["showEdit"] : $this->getContext($context, "showEdit"))) {
            echo "8";
        } else {
            echo "12";
        }
...
";
    ...
    public function block_sonata_address_name($context, array $blocks = array())
    {
        // line 7
        echo "                    ";
        if ((isset($context["showName"]) ? $context["showName"] : $this->getContext($context, "showName"))) {
            echo "<strong>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["address"]) ? $context["address"] : $this->getContext($context, "address")), "name", array()), "html", null, true);
            echo "</strong><br/>";
        }
        // line 8
        echo "                ";
    ...
    public function block_sonata_address_address($context, array $blocks = array())
    {
        // line 10
        echo "                    ";
        echo $this->getAttribute((isset($context["address"]) ? $context["address"] : $this->getContext($context, "address")), "address", array());
        echo "
                ";
    }
    ...
    public function block_sonata_address_edit($context, array $blocks = array())
    {
        ...
        if ((isset($context["showEdit"]) ? $context["showEdit"] : $this->getContext($context, "showEdit"))) {
            ...
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("sonata_customer_address_edit", array("id" => $this->getAttribute((isset($context["address"]) ? $context["address"] : $this->getContext($context, "address")), "id", array()), "context" => (isset($context["context"]) ? $context["context"] : $this->getContext($context, "context")))), "html", null, true);
