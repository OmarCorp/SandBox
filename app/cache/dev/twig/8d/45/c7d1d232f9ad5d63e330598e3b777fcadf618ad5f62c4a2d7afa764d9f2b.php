...
class __TwigTemplate_8d45c7d1d232f9ad5d63e330598e3b777fcadf618ad5f62c4a2d7afa764d9f2b extends Sonata\CacheBundle\Twig\TwigTemplate14
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        if ((twig_length_filter($this->env, (isset($context["containers"]) ? $context["containers"] : $this->getContext($context, "containers"))) == 0)) {
            ...
            // line 92
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : $this->getContext($context, "admin_pool")), "getAdminByAdminCode", array(0 => "sonata.page.admin.block"), "method"), "generateUrl", array(0 => "savePosition", 1 => array("id" => $this->getAttribute((isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")), "id", array()))), "method"), "html", null, true);
            echo "\",
                            block_switch_parent:   \"";
            // line 93
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : $this->getContext($context, "admin_pool")), "getAdminByAdminCode", array(0 => "sonata.page.admin.block"), "method"), "generateUrl", array(0 => "switchParent"), "method"), "html", null, true);
            echo "\",
                            block_preview:         \"";
            // line 94
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : $this->getContext($context, "admin_pool")), "getAdminByAdminCode", array(0 => "sonata.page.admin.block"), "method"), "generateUrl", array(0 => "composePreview", 1 => array("block_id" => "BLOCK_ID")), "method"), "html", null, true);
            echo "\"
                        }
                    });
                    composer.csrfTokens = ";
