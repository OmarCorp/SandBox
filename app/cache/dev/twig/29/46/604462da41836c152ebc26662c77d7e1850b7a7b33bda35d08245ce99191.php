...
class __TwigTemplate_2946604462da41836c152ebc26662c77d7e1850b7a7b33bda35d08245ce99191 extends Sonata\CacheBundle\Twig\TwigTemplate14
{
...
<div>
    ...
    <form method=\"POST\">
        ";
        // line 14
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "media", array()), "binaryContent", array()), 'widget', array("attr" => array("class" => "span8")));
        echo "
...
";
        // line 22
        if (((isset($context["media"]) ? $context["media"] : $this->getContext($context, "media")) && $this->getAttribute((isset($context["media"]) ? $context["media"] : $this->getContext($context, "media")), "providerReference", array()))) {
            // line 23
            echo "    <h2>Preview : ";
    ...
    ";
            // line 25
            echo $this->env->getExtension('sonata_media')->media((isset($context["media"]) ? $context["media"] : $this->getContext($context, "media")), "reference", array());
            // line 26
            echo "
    <p>
