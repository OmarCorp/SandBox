...
class __TwigTemplate_ccdfa20016a51c9ce50c1754f820310943c5ab13cc02690491aef257088bff6c extends Sonata\CacheBundle\Twig\TwigTemplate14
{
    ...
    public function block_fos_comment_form_fields($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "authorName", array(), "any", true, true)) {
            ...
            echo "                                    <div class=\"col-sm-3\">
                                        ";
            // line 41
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "authorName", array()), 'label', array("horizontal_label_class" => "") + (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("form_label_author_name", array(), "SonataCommentBundle")) ? array() : array("label" => $_label_)));
            echo "
                                        ";
            // line 42
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "authorName", array()), 'widget', array("horizontal_input_wrapper_class" => ""));
            echo "
                                    </div>
                                ";
        }
        ...
        echo "
                                <div class=\"col-sm-3\">
                                    ";
        // line 47
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "website", array()), 'label', array("horizontal_label_class" => "") + (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("form_label_website", array(), "SonataCommentBundle")) ? array() : array("label" => $_label_)));
        echo "
                                    ";
        // line 48
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "website", array()), 'widget', array("horizontal_input_wrapper_class" => ""));
        echo "
                                </div>
                                ...
                                <div class=\"col-sm-3\">
                                    ";
        // line 52
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "email", array()), 'label', array("horizontal_label_class" => "") + (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("form_label_email", array(), "SonataCommentBundle")) ? array() : array("label" => $_label_)));
        echo "
                                    ";
        // line 53
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "email", array()), 'widget', array("horizontal_input_wrapper_class" => ""));
        echo "
                                </div>
                                ...
                                <div class=\"col-sm-3\">
                                    ";
        // line 57
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "note", array()), 'label', array("horizontal_label_class" => "") + (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("form_label_note", array(), "SonataCommentBundle")) ? array() : array("label" => $_label_)));
        echo "
                                    ";
        // line 58
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "note", array()), 'widget', array("horizontal_input_wrapper_class" => ""));
        echo "
                                </div>
                            </div>
                            <div class=\"row\">
                                <div class=\"col-sm-12\">
                                    ";
        // line 63
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "body", array()), 'label', array("horizontal_label_class" => "") + (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("form_label_body", array(), "SonataCommentBundle")) ? array() : array("label" => $_label_)));
        echo "
                                    ";
        // line 64
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "body", array()), 'widget', array("horizontal_input_wrapper_class" => ""));
        echo "
                                </div>
                            </div>
