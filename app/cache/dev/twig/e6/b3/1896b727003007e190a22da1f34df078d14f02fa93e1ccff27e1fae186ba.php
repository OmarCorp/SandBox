...
class __TwigTemplate_e6b31896b727003007e190a22da1f34df078d14f02fa93e1ccff27e1fae186ba extends Sonata\CacheBundle\Twig\TwigTemplate14
{
...
";
    ...
    public function block_stepper_content($context, array $blocks = array())
    {
        ...
        <li";
        // line 7
        if (("basket" == (isset($context["step"]) ? $context["step"] : $this->getContext($context, "step")))) {
            echo " class=\"active\"";
        }
        echo ">
        ...
        <li";
        // line 13
        if (("identification" == (isset($context["step"]) ? $context["step"] : $this->getContext($context, "step")))) {
            echo " class=\"active\"";
        }
        echo ">
        ...
        <li";
        // line 19
        if (("delivery" == (isset($context["step"]) ? $context["step"] : $this->getContext($context, "step")))) {
            echo " class=\"active\"";
        }
        echo ">
        ...
        <li";
        // line 25
        if (("billing" == (isset($context["step"]) ? $context["step"] : $this->getContext($context, "step")))) {
            echo " class=\"active\"";
        }
        echo ">
        ...
        <li";
        // line 31
        if (("checkout" == (isset($context["step"]) ? $context["step"] : $this->getContext($context, "step")))) {
            echo " class=\"active\"";
        }
        echo ">
