...
class __TwigTemplate_f42f08640a22235c96f5ce36a97b4b3b89b2c29341f126f92f56e966ba5e6d15 extends Sonata\CacheBundle\Twig\TwigTemplate14
{
    ...
    public function block_product_details($context, array $blocks = array())
    {
        ...
        // line 34
        echo $this->env->getExtension('sonata_intl_number')->formatCurrency($this->getAttribute((isset($context["basketElement"]) ? $context["basketElement"] : $this->getContext($context, "basketElement")), "getUnitPrice", array(0 => true), "method"), $this->getAttribute((isset($context["currency"]) ? $context["currency"] : $this->getContext($context, "currency")), "label", array()), array(), array(), (isset($context["locale"]) ? $context["locale"] : $this->getContext($context, "locale")));
        echo "</dd>
        ...
        echo "</dt>
                            <dd style=\"margin-left: 110px;\">";
        // line 37
        echo twig_escape_filter($this->env, (isset($context["quantity"]) ? $context["quantity"] : $this->getContext($context, "quantity")), "html", null, true);
        echo "</dd>
        ...
        echo "</dt>
                            <dd style=\"margin-left: 110px;\">";
        // line 40
        echo $this->env->getExtension('sonata_intl_number')->formatCurrency((isset($context["price"]) ? $context["price"] : $this->getContext($context, "price")), $this->getAttribute((isset($context["currency"]) ? $context["currency"] : $this->getContext($context, "currency")), "label", array()), array(), array(), (isset($context["locale"]) ? $context["locale"] : $this->getContext($context, "locale")));
        echo "</dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class=\"col-md-12\">
                    <p>";
        // line 46
        echo $this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "rawShortDescription", array());
        echo "</p>
                </div>
            ";
    }
    ...
    {
        echo $this->env->getExtension('sonata_media')->thumbnail($this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "image", array()), "small", array("itemprop" => "image", "class" => "img-rounded img-responsive"));
    }
    ...
    public function block_product_properties($context, array $blocks = array())
    {
        // line 29
        echo "                            ";
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('sonata_page')->controller(($this->getAttribute((isset($context["provider"]) ? $context["provider"] : $this->getContext($context, "provider")), "baseControllerName", array()) . ":renderProperties"), array("product" => (isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")))));
        echo "
                        ";
    }
