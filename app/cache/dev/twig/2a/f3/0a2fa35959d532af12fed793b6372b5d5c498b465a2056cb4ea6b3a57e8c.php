...
class __TwigTemplate_2af30a2fa35959d532af12fed793b6372b5d5c498b465a2056cb4ea6b3a57e8c extends Sonata\CacheBundle\Twig\TwigTemplate14
{
...
";
        ...
        if (((isset($context["depth"]) ? $context["depth"] : $this->getContext($context, "depth")) == 0)) {
            ...
            if ($this->env->getExtension('fos_comment')->canCommentThread((isset($context["thread"]) ? $context["thread"] : $this->getContext($context, "thread")))) {
                // line 17
                echo "        ";
                echo $this->env->getExtension('actions')->renderUri($this->env->getExtension('routing')->getUrl("fos_comment_new_thread_comments", array("id" => $this->getAttribute((isset($context["thread"]) ? $context["thread"] : $this->getContext($context, "thread")), "id", array()))), array());
                // line 18
                echo "    ";
            }
            // line 19
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["commentinfo"]) {
            ...
            if ( !$this->getAttribute($this->getAttribute($context["commentinfo"], "comment", array()), "private", array())) {
                // line 34
                echo "        ";
                $this->env->loadTemplate("FOSCommentBundle:Thread:comment.html.twig")->display(array_merge($context, array("children" => $this->getAttribute($context["commentinfo"], "children", array()), "comment" => $this->getAttribute($context["commentinfo"], "comment", array()), "depth" => (isset($context["depth"]) ? $context["depth"] : $this->getContext($context, "depth")), "view" => (isset($context["view"]) ? $context["view"] : $this->getContext($context, "view")))));
                // line 35
                echo "    ";
            }
            ++$context['loop']['index0'];
