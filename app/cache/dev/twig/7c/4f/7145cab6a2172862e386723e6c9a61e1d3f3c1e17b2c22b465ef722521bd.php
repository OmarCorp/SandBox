...
class __TwigTemplate_7c4f7145cab6a2172862e386723e6c9a61e1d3f3c1e17b2c22b465ef722521bd extends Sonata\CacheBundle\Twig\TwigTemplate14
{
    ...
    data-block-enabled=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")), "enabled", array()), "html", null, true);
        echo "\"
>
    ...
    >
        ...
        // line 9
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["child"]) ? $context["child"] : null), "name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["child"]) ? $context["child"] : null), "name", array()), $this->getAttribute($this->getAttribute((isset($context["blockServices"]) ? $context["blockServices"] : $this->getContext($context, "blockServices")), $this->getAttribute((isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")), "type", array())), "name", array()))) : ($this->getAttribute($this->getAttribute((isset($context["blockServices"]) ? $context["blockServices"] : $this->getContext($context, "blockServices")), $this->getAttribute((isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")), "type", array())), "name", array()))), "html", null, true);
        echo "</h4>
        <small>";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["blockServices"]) ? $context["blockServices"] : $this->getContext($context, "blockServices")), $this->getAttribute((isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")), "type", array())), "name", array()), "html", null, true);
        echo "</small>
    ...
    <div class=\"page-composer__container__child__right\">
        ...
        echo "\" href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("sonata_admin_set_object_field_value", array("objectId" => $this->getAttribute((isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")), "id", array()), "context" => "list", "field" => "enabled", "code" => "sonata.page.admin.block")), "html", null, true);
        echo "\">";
