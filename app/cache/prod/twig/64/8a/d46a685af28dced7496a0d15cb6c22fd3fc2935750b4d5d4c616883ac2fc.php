...
class __TwigTemplate_648ad46a685af28dced7496a0d15cb6c22fd3fc2935750b4d5d4c616883ac2fc extends Sonata\CacheBundle\Twig\TwigTemplate14
{
                            ...
                            jQuery(document).ready(function() {
                                Sonata.Page.init({
                                    url: {
                                        block_save_position: '";
                // line 60
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_sonata_page_block_savePosition", array("id" => $this->getAttribute((isset($context["page"]) ? $context["page"] : null), "id", array()))), "html", null, true);
                echo "',
                                        block_edit:          '";
                // line 61
