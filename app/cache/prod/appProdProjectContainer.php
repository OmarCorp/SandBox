...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'dbname' => 'sonata_sandbox', 'user' => 'root', 'host' => '127.0.0.1', 'password' => 'omar', 'charset' => 'UTF8', 'port' => NULL, 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c5bcb0843f708e147d6fadca6e4a15bcf33daef19d0addfa60489e8146d3fb58');
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/app_prod.log'), 100, true, NULL);
    }
    ...
    {
        return $this->services['sonata.media.extra.pixlr'] = new \Sonata\MediaBundle\Extra\Pixlr('Demo - Sonata Project', '43fdc2fceb141075ec2e62d4f54fcc89639f0734', $this->get('sonata.media.pool'), $this->get('sonata.media.manager.media'), $this->get('cmf_routing.router'), $this->get('templating'), $this);
    }
    ...
    {
        $this->services['sonata.payment.method.pass'] = $instance = new \Sonata\Component\Payment\PassPayment($this->get('cmf_routing.router'), new \Buzz\Browser(new \Buzz\Client\Curl()));
